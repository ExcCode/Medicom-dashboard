			...
			<div className="sidebar-inner slimscroll">
				<div id="sidebar-menu" className="sidebar-menu">
					<ul>
						...
						<li className={pathname.includes('medicals') ?"active" :""}>
							<Link to="/admin/medicals"><i><FeatherIcon icon="user-plus" /></i> <span>Medicals</span></Link>
						</li>
						<li className={pathname.includes('doctors') ?"active" :""}>
							<Link to="/admin/doctors"><i><FeatherIcon icon="user-plus" /></i> <span>Doctors</span></Link>
						</li>
						<li className={pathname.includes('patients') ?"active" :""}>
							<Link to="/admin/patients"><i><FeatherIcon icon="users" /></i> <span>Patients</span></Link>
						</li>
						...
						<li className="submenu">
							...
							<ul style={{ display: isSideMenu== "authentication"? "block" : "none" }}>
								<li><Link to="/admin/login" className={pathname.includes('login') ?"active" :""}> Login </Link></li>
								<li><Link to="/admin/register" className={pathname.includes('register') ?"active" :""}> Register </Link></li>
								<li><Link to="/admin/forgotpassword" className={pathname.includes('forgotpassword') ?"active" :""}> Forgot Password </Link></li>
								<li><Link to="/admin/lockscreen" className={pathname.includes('lockscreen') ?"active" :""}> Lock Screen </Link></li>
							</ul>
						</li>
						<li className="submenu">
							...
							<ul style={{ display: isSideMenu== "errorpages"? "block" : "none" }}>
								<li><Link to="/admin/404" className={pathname.includes('404') ?"active" :""}>404 Error </Link></li>
								<li><Link to="/admin/500" className={pathname.includes('500') ?"active" :""}>500 Error </Link></li>
							</ul>
						</li>
